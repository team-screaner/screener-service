...
'AssessmentInput':obj({'user_matrix_id':string,'period':string,'type':{'type':'string','enum':['self']},'items':arr(ref('AssessmentItem'))},['user_matrix_id','period','type','items']),
...
S['Assessment']['properties']['created_at']=string
